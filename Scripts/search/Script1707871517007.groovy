...
Mobile.setText(findTestObject('Object Repository/search/android.widget.EditText - Search'), 'hp', 0)

Mobile.tap(findTestObject('Object Repository/search/android.widget.ImageView'), 0)

Mobile.tap(findTestObject('Object Repository/search/android.widget.ImageView (2)'), 0)
